...
from .models import Product, Screen ,DailyChecklistItem,MonthlyChecklistItem,WeeklyChecklistItem,StartUpCheckSheet,RejectionSheet,Defects,MachineLocation,SolderingBitRecord,PChartData,ControlChartStatistics,ControlChartReading
